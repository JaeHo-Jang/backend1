...
public class CalculatorEx {
    public static void main(String[] args) {
        ...
        int minus = calculator.minus(a,b);     // minus함수를 만들고 a,b를 실어보낼거야 -> 어디? Calculaoter 자바의 퍼블릭 객체
...
//------------------------------------------------------------------------------//
        ...
        // printf("포멧(형식), 변수)" : %x.y(리터럴)
        // - 형식기호를 사용하여, 값 형식에 따라 표현하는 메소드
        // x : 양수 - 크기만큼 칸을 지정하고 오른쪽 정렬
        //      음수 - 크기만큼 칸을 지정하고 왼쪽 정렬
        // y : 지정한 크기만큼 소수점 아래 자리수를 표현(반올림)
        // 리터럴 : %d(정수)   ,  %f(실수).   %s(문자열) 을 뜻한다.
        // ex) printf("%d | %d" ,  a,b);
        //  ㄴ   출력 : 10 | 20
